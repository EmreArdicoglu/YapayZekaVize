    ...
    public partial class MLModel1
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"Data as of", @"Data as of"),new InputOutputColumnPair(@"Start Date", @"Start Date"),new InputOutputColumnPair(@"End Date", @"End Date"),new InputOutputColumnPair(@"Sex", @"Sex")})      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTreeTweedie(new FastTreeTweedieTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=53,NumberOfTrees=9,MaximumBinCountPerFeature=786,LearningRate=1F,FeatureFraction=0.656180160945129F,LabelColumnName=@"COVID-19 Deaths",FeatureColumnName=@"Features"}));
